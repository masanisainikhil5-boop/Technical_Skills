...
- Location: tests\FileUpload\Filedownload.spec.ts:9:9
...
Expected substring: "ttanotes"
Received string:    "tta-notes.txt"
```
          ...
          - generic [ref=e536]:
            ...
            - article [ref=e578]:
              ...
              - paragraph [ref=e580]:
                ...
                - text: .
              - generic [ref=e583]:
                - button "Download text file" [active] [ref=e584] [cursor=pointer]
            ...
            - generic [ref=e592]: "{ \"kind\": \"download\", \"file\": \"tta-notes.txt\" }"
...
```ts
  ...
  3  | 
  4  | test.describe('File Upload and Download Scenarios', () =>{
  5  |     test.beforeEach(async({page}) =>{
  6  |         page.goto("https://app.thetestingacademy.com/playwright/widgets/upload-download")
  7  |     })
  8  | 
  9  |     test('Demo: Upload and Download the files:', async({page}) =>{
  10 | 
  11 |         const [download] = await Promise.all([
  12 |             page.waitForEvent('download'),
  13 |             page.getByTestId('download-text').click()       
  14 |         ])
  15 | 
> 16 |         expect(download.suggestedFilename()).toContain('ttanotes')
     |                                              ^ Error: expect(received).toContain(expected) // indexOf
  17 |         await download.saveAs(path.join(__dirname,'downloads','ttanotes.txt'))
  18 |     })
  19 | })
```