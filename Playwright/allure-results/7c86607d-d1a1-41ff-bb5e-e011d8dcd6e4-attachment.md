...
```
Error: locator.click: Error: strict mode violation: getByText('TypeScript') resolved to 8 elements:
    1) <option value="typescript">TypeScript</option> aka getByTestId('language-select')
    2) <div class="text-[11.5px] leading-[1.5] text-muted-foreground">…</div> aka getByText('Expected: Language select')
    3) <span class="practice-code-label font-[family-name:var(--font-ibm-plex-mono)] text-[11px] font-semibold">TypeScript</span> aka locator('#learn-visible-text').getByText('TypeScript')
    4) <span class="practice-code-label font-[family-name:var(--font-ibm-plex-mono)] text-[11px] font-semibold">TypeScript</span> aka locator('#learn-value').getByText('TypeScript')
    5) <span class="practice-code-label font-[family-name:var(--font-ibm-plex-mono)] text-[11px] font-semibold">TypeScript</span> aka locator('#learn-options').getByText('TypeScript')
    6) <span class="practice-code-label font-[family-name:var(--font-ibm-plex-mono)] text-[11px] font-semibold">TypeScript</span> aka locator('#learn-multi').getByText('TypeScript')
    7) <span class="practice-code-label font-[family-name:var(--font-ibm-plex-mono)] text-[11px] font-semibold">TypeScript</span> aka locator('#learn-custom').getByText('TypeScript', { exact: true })
    8) <span class="practice-code-label font-[family-name:var(--font-ibm-plex-mono)] text-[11px] font-semibold">TypeScript</span> aka locator('#learn-searchable span').filter({ hasText: 'TypeScript' })
                ...
                - generic [ref=e95]:
                  ...
                  - generic [ref=e100]:
                    - generic [ref=e101]:
                      ...
                      - combobox "Select Language" [active] [ref=e103]:
...
> 48 |         await page.getByText('TypeScript').click()
     |                                            ^ Error: locator.click: Error: strict mode violation: getByText('TypeScript') resolved to 8 elements:
  49 | 
