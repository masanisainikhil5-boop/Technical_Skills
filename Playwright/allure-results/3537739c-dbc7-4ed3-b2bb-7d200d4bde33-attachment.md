...
Locator:  locator('#languageSelect')
Expected: "Selected TypeScript; options: Python, Java, JavaScript, TypeScript"
Received: "typescript"
Timeout:  5000ms
...
Call log:
  ...
  - waiting for locator('#languageSelect')
    13 × locator resolved to <select name="language" id="languageSelect" data-testid="language-select" data-list-id="language-options-2026" class="dropdowns-module__P6SCTq__practiceSelect">…</select>
       - unexpected value "typescript"
...
```ts
  ...
  49 | 
  50 |         await page.locator('#selectLastLanguageBtn').click()
  51 | 
