...
```
Error: locator.click: Error: strict mode violation: getByText('TypeScript', { exact: true }) resolved to 7 elements:
    1) <option value="typescript">TypeScript</option> aka getByTestId('language-select')
    2) <span class="practice-code-label font-[family-name:var(--font-ibm-plex-mono)] text-[11px] font-semibold">TypeScript</span> aka locator('#learn-visible-text').getByText('TypeScript')
    3) <span class="practice-code-label font-[family-name:var(--font-ibm-plex-mono)] text-[11px] font-semibold">TypeScript</span> aka locator('#learn-value').getByText('TypeScript')
    4) <span class="practice-code-label font-[family-name:var(--font-ibm-plex-mono)] text-[11px] font-semibold">TypeScript</span> aka locator('#learn-options').getByText('TypeScript')
    5) <span class="practice-code-label font-[family-name:var(--font-ibm-plex-mono)] text-[11px] font-semibold">TypeScript</span> aka locator('#learn-multi').getByText('TypeScript')
    6) <span class="practice-code-label font-[family-name:var(--font-ibm-plex-mono)] text-[11px] font-semibold">TypeScript</span> aka locator('#learn-custom').getByText('TypeScript', { exact: true })
    7) <span class="practice-code-label font-[family-name:var(--font-ibm-plex-mono)] text-[11px] font-semibold">TypeScript</span> aka locator('#learn-searchable span').filter({ hasText: 'TypeScript' })

Call log:
  - waiting for getByText('TypeScript', { exact: true })
