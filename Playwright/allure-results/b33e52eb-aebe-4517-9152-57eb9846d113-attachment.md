...
- Name: DDT\ddt.spec.ts >> DDT practice >> Login with: empty password
- Location: tests\DDT\ddt.spec.ts:44:13
...
Received string:  "https://app.thetestingacademy.com/playwright/multiple_element_filter?email=pramod%40ppp.com&password=#login-success"
Timeout: 5000ms

Call log:
  - Expect "toHaveURL" with timeout 5000ms
    5 × unexpected value "https://app.thetestingacademy.com/playwright/multiple_element_filter?email=pramod%40ppp.com&password=#login-success"
...
```ts
  ...
  12 |         },
  13 |         {
  14 |             description: "invalid password",
  ...
  24 |             expectedURL: /admin123/,
  25 |             shouldPass: false
  26 |         },
  27 |         {
  28 |             description: "empty password",
  29 |             username: "pramod@ppp.com",
  30 |             password: "",
  ...
  46 | 
  47 |             let emailadd = page.getByRole('textbox', {name: 'Email Address'})
  48 |             let password = page.getByRole('textbox', {name: 'Password'})
  49 |             let loginbutton = page.getByText('Login to Practice Account')
  50 | 
  51 |             await emailadd.fill(data.username)
  52 |             await password.fill(data.password)
  53 |             await loginbutton.click()
  54 | 
> 55 |             await expect(page).toHaveURL(data.expectedURL);
     |                                ^ Error: expect(page).toHaveURL(expected) failed
  56 |         } )
  57 |     }
  58 | })
